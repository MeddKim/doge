...
import com.jfinal.plugin.activerecord.sql.*;
...
public class ParaDirective extends Directive {
	...
	public void exec(Env env, Scope scope, Writer writer) {
		SqlPara sqlPara = (SqlPara)scope.get(com.jfinal.plugin.activerecord.sql.SqlKit.SQL_PARA_KEY);
		if (sqlPara == null) {
		...
		if (index == -1) {
			...
			Object[] paras = (Object[])scope.get(com.jfinal.plugin.activerecord.sql.SqlKit.PARA_ARRAY_KEY);
			if (paras == null) {
