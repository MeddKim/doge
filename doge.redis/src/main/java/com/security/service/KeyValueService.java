...
import com.security.utils.Constants;
...
public interface KeyValueService {
    ...
    default void put(String key, String value) {
        put(key, Constants.SECONDS_OF_ONE_DAY, value);
    }
    ...
    default <T> T getOrDefault(String key, T defaultValue) {
        return getOrDefault(key, defaultValue, Constants.SECONDS_OF_ONE_DAY);
    }
    ...
    default <T> T getOrDefaultSystemVariable(String key, T defaultValue) {
        return getOrDefaultSystemVariable(key, defaultValue, Constants.SECONDS_OF_ONE_DAY);
    }
    ...
    default void setAdd(String key, Collection<?> objects) {
        setAdd(key, objects, Constants.SECONDS_OF_ONE_DAY);
    }
